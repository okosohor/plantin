...
export default function HeroBlock({ query, handleSearch }: Props) {
  ...
  return (
    <section className="relative flex w-full bg-brand-green-light p-4 lg:p-[3.5rem] rounded-2xl  flex-col items-start justify-center mb-[1.125rem] lg:mb-12">
      <h4 className="text-brand-green font-extrabold text-[1.5rem] lg:text-[2rem]  mb-2">
        Stay always tuned with planting trends
      </h4>
      <p className="lg:hidden font-bold text-[1.125rem] text-brand-black mb-4">
        Tips & Tricks <span className="font-medium">selected specially for</span> you!
      </p>
      <TemperatureString />
