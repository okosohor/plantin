...
export default function TryForFreeBlock() {
  return (
    <section className="relative col-span-3 flex flex-col bg-brand-green-light lg:bg-gradient-to-r lg:from-brand-green-gradient-start lg:to-brand-green-gradient-end rounded-2xl lg:rounded-xl w-full lg:p-6 p-4 mb-6 lg:mb-[3.5rem]">
      <Logo/>
